  ...
  return (
    <div className='form-group'>
        ...
        <div className="fg-item">
            ...
            <select className='form-select' {...register("bean")} name="bean" id="bean" disabled={isSubmitting} >
        ...
        <div className="fg-item fg-left">
            ...
            <input className='form-input' {...register("description")} type="text" name='description' id='description' placeholder='Description' disabled={isSubmitting}/>
            {errors['description'] && <span className='error-message'>✖ {errors['description'].message}</span>}
        </div>
        <div className="fg-item fg-right">
            <label htmlFor="targetRoastLevel">Target Roast Level: </label>
            <select className='form-select' {...register('targetRoastLevel')} name="targetRoastLevel" id="targetRoastLevel" disabled={isSubmitting}>
        ...
        <div className="fg-item fg-left">
            ...
            <input className='form-input' {...register("phTemp")} type="text" name='phTemp' id='phTemp' placeholder='°F' disabled={isSubmitting}/>
            {errors['phTemp'] && <span className='error-message'>✖ {errors['phTemp'].message}</span>}
        </div>
        <div className="fg-item fg-right">
            <label htmlFor="phTime">Pre-Heat Time: </label>
            <input className='form-input' {...register("phTime")} type="text" name='phTime' id='phTime' placeholder='mins.' disabled={isSubmitting}/>
        ...
        <div className='fg-item fg-left'>
            ...
            <input className='form-input' {...register("roastProfile.startWeight")} type="text" name="roastProfile.startWeight" id="startWeight" placeholder="(g)" disabled={isSubmitting}/>
        ...
        <div className='fg-item fg-right'>
            ...
            <input className='form-input' {...register("roastProfile.endWeight")} type="text" name='roastProfile.endWeight' id='endWeight' placeholder="(g)" disabled={isSubmitting}/>
        ...
        <div className='fg-item fg-left'>
            ...
            <input className='form-input' {...register("roastProfile.firstCrack")} type="text" name="roastProfile.firstCrack" id="firstCrack" placeholder='mm:ss' disabled={isSubmitting}/>
            {errors.roastProfile?.['firstCrack'] && <span className='error-message'>✖ {errors.roastProfile?.['firstCrack'].message}</span>}
        </div>
        <div className='fg-item fg-right'>
            <label htmlFor="roastProfile.rollingFirstCrack">Rolling First Crack: </label>
            <input className='form-input' {...register("roastProfile.rollingFirstCrack")} type="text" name="roastProfile.rollingFirstCrack" id="rollingFirstCrack" placeholder='mm:ss' disabled={isSubmitting}/>
        ...
        <div className='fg-item fg-left'>
            ...
            <input className='form-input' {...register("roastProfile.secondCrack")} name='roastProfile.secondCrack' id='secondCrack' placeholder='mm:ss' disabled={isSubmitting}/>
        ...
        <div className='fg-item fg-right'>
            ...
            <input className='form-input' {...register("roastProfile.totalRoastTime")} name='roastProfile.totalRoastTime' id='totalRoastTime' placeholder='mm:ss' disabled={isSubmitting}/>
        ...
        <div className='fg-item fg-left'>
            ...
            <select className='form-select' {...register("roastProfile.color")}  name="roastProfile.color" id="color" disabled={isSubmitting}>
        ...
        <div className='fg-item fg-right'>
            ...
            <select className='form-select' {...register('roastProfile.roastLevel')} name="roastProfile.roastLevel" id="roastLevel" disabled={isSubmitting}>
              <option value="" hidden>Select Roast Level</option>
              <option value="City">City</option>
              <option value="City +">City +</option>
              <option value="Full City">Full City</option>
        ...
        <div className='fg-item fg-notes'>
            ...
            <textarea className='form-select'{...register("roastProfile.roastNotes")} name='roastProfile.roastNotes' id='roastNotes' placeholder="Don't Forget to take notes!" disabled={isSubmitting}/>
            {errors.roastProfile?.['roastNotes'] && <span className='error-message'>✖ {errors.roastProfile?.['roastNotes'].message}</span>}
        </div>
        <input className='fg-item primaryBtn' type="submit" disabled={isSubmitting} />
    </div>
  )
}
