...
router.patch("/:id", verifyJWT, getRoastLog, async (req, res) => {
  ...
  if (req.body.roastProfile.rollingFirstCrack != null) {
    res.roastLog.roastProfile.rollingFirstCrack =
      req.body.roastProfile.rollingFirstCrack;
  }
  ...
  if (req.body.roastProfile.totalRoastTime != null) {
    res.roastLog.roastProfile.totalRoastTime =
      req.body.roastProfile.totalRoastTime;
  }
